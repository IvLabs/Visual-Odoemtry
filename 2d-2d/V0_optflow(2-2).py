...
path = glob.glob("C:\\Users\\DELL\\Desktop\\VisualOdometry\\Visual-Odometry\\KITTI_sample\\image_8\\*.png")
...
data = np.loadtxt("C:\\Users\\DELL\\Desktop\\VisualOdometry\\Visual-Odometry\\KITTI_sample\\08.txt", delimiter=" ")
x_g = []
y_g = []
